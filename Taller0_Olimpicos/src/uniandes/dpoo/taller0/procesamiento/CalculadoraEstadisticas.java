...
public class CalculadoraEstadisticas
{
	 ...
	 * @return Una lista de mapas con la información de todos los atletas del país.
	 *         Cada registro de un atleta queda en un mapa que tiene una llave:
 	 *		   "nombre" que tiene asociado el nombre del atleta.
	 * 
	 *         Si no se encuentra el atleta indicado, se retorna null.
	 */
